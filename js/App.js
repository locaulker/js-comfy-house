...
class UI {
  ...
  addCartItem(item) {
    ...
    div.innerHTML = `
      ...
      <div>
        <i class="fal fa-chevron-up" data-id="${item.id}"></i>
  ...
  // clear cart, remove item, & increase/decrease quantity
  cartLogic() {
    // clear cart
    ...
    removeItem(id) {
      ...
      button.innerHTML = `<i class="fad fa-shopping-cart"></i>add to cart`;
    }
